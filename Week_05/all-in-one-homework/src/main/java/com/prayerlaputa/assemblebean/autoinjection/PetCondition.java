...
//        System.out.println(annotatedTypeMetadata.getClass().getName());
        ...
        System.out.println("---------------------------------");
        System.out.println("当前是否已存在cat对象：" + conditionContext.getRegistry().containsBeanDefinition("cat"));
        System.out.println("当前使用Condition判断的方法名：" + standardMethodMetadata.getMethodName());
        System.out.println("---------------------------------");
